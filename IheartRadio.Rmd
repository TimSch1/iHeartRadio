...
Given 3 data tables the objective is to answer provided questions, compute statistics, and gain insight on iHeartRadio users. First, the tables are read into R.
...
Interestingly, the plot also reveals an interesting interaction effect. Among Active users females dominate at younger ages but decay much more quickly than their male conterparts leaving a slight male majority of Active users at older ages. This rapid disengagement is not reflected in the Inactive population suggesting the data may be incomplete.
...
ggplot(data.frame(agediff_dist), aes(x=agediff_dist))+
        ...
        ylab('Count')+
        ggtitle('Randomization Distribution of Differences in Mean Age')+
        theme_bw()
